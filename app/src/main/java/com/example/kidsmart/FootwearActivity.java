...
public class FootwearActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerSearchFootwear);
        searchView = findViewById(R.id.searchFootwearView);
        filterColorSpinner = findViewById(R.id.filterColorFootwear);
        minPriceEditText = findViewById(R.id.minPriceFootwear);
        maxPriceEditText = findViewById(R.id.maxPriceFootwear);
    ...
    private void loadFootwearProducts() {
        databaseReference.orderByChild("category").equalTo("Footwear")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(FootwearActivity.this, "Failed to load products.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
