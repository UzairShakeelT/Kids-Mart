...
public class ToysActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerSearchToys);
        searchView = findViewById(R.id.searchToysView);
        filterColorSpinner = findViewById(R.id.filterColorToys);
        minPriceEditText = findViewById(R.id.minPriceToys);
        maxPriceEditText = findViewById(R.id.maxPriceToys);
    ...
    private void loadToysProducts() {
        databaseReference.orderByChild("category").equalTo("Toys")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(ToysActivity.this, "Failed to load products.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
